...
public class BurgerQueueManagement {
    public static Cashiers cashiers = new Cashiers();//Initializing  cashier object
        ...
        while (true) { //this while loops until user exits the program!
            ...
            System.out.println("""
                    Welcome to Foodies Fave Food center
                        ...
                        112 or GUI: View Graphical User Interface
            ...
            switch ((command.toUpperCase())) {
                ...
                case "112":
                case "GUI":
                    Application.launch(BurgerQueueApplication.class);
                    break;
